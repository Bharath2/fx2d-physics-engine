...
int main() {
    ...
    auto report = [&](int step) {
        std::cout << std::setw(6) << step * dt
                  << std::setw(9) << truck_head->pose.x()
                  << std::setw(8) << truck_head->pose.y()
                  << std::setw(9) << truck_head->pose.z()
                  << std::setw(11) << wheel1->velocity.z()
                  << std::setw(10) << wheel2->velocity.z()
    ...
    std::cout << "\nTruck settled at x=" << truck_head->pose.x()
              << " y=" << truck_head->pose.y()
