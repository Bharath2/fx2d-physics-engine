...
const KeyBinding kKeyBindings[] = {
    {FxKey::A, KEY_A}, {FxKey::B, KEY_B}, {FxKey::C, KEY_C}, {FxKey::D, KEY_D},
    {FxKey::E, KEY_E}, {FxKey::F, KEY_F}, {FxKey::G, KEY_G}, {FxKey::H, KEY_H},
    {FxKey::I, KEY_I}, {FxKey::J, KEY_J}, {FxKey::K, KEY_K}, {FxKey::L, KEY_L},
    {FxKey::M, KEY_M}, {FxKey::N, KEY_N}, {FxKey::O, KEY_O}, {FxKey::P, KEY_P},
    {FxKey::Q, KEY_Q}, {FxKey::R, KEY_R}, {FxKey::S, KEY_S}, {FxKey::T, KEY_T},
    {FxKey::U, KEY_U}, {FxKey::V, KEY_V}, {FxKey::W, KEY_W}, {FxKey::X, KEY_X},
    {FxKey::Y, KEY_Y}, {FxKey::Z, KEY_Z},
    {FxKey::Num0, KEY_ZERO}, {FxKey::Num1, KEY_ONE},   {FxKey::Num2, KEY_TWO},
    {FxKey::Num3, KEY_THREE}, {FxKey::Num4, KEY_FOUR}, {FxKey::Num5, KEY_FIVE},
    {FxKey::Num6, KEY_SIX},   {FxKey::Num7, KEY_SEVEN}, {FxKey::Num8, KEY_EIGHT},
    {FxKey::Num9, KEY_NINE},
    {FxKey::Left, KEY_LEFT}, {FxKey::Right, KEY_RIGHT}, {FxKey::Up, KEY_UP}, {FxKey::Down, KEY_DOWN},
    {FxKey::Space, KEY_SPACE}, {FxKey::Enter, KEY_ENTER}, {FxKey::Escape, KEY_ESCAPE},
    {FxKey::Tab, KEY_TAB}, {FxKey::Backspace, KEY_BACKSPACE}, {FxKey::Delete, KEY_DELETE},
    {FxKey::LeftShift, KEY_LEFT_SHIFT}, {FxKey::RightShift, KEY_RIGHT_SHIFT},
    {FxKey::LeftCtrl, KEY_LEFT_CONTROL}, {FxKey::RightCtrl, KEY_RIGHT_CONTROL},
    {FxKey::LeftAlt, KEY_LEFT_ALT}, {FxKey::RightAlt, KEY_RIGHT_ALT},
    {FxKey::F1, KEY_F1}, {FxKey::F2, KEY_F2}, {FxKey::F3, KEY_F3}, {FxKey::F4, KEY_F4},
    {FxKey::F5, KEY_F5}, {FxKey::F6, KEY_F6}, {FxKey::F7, KEY_F7}, {FxKey::F8, KEY_F8},
    {FxKey::F9, KEY_F9}, {FxKey::F10, KEY_F10}, {FxKey::F11, KEY_F11}, {FxKey::F12, KEY_F12},
};
// clang-format on
